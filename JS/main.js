...
fetch('JS/items.json')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (container) {
            ...
            paragraph.innerHTML = ` Olá, meu nome é Guilherme Castro. Sou formado em Desenvolvimento Web pelo Instituto da Oportunidade Social (IOS) e, atualmente, estou aprimorando meus conhecimentos em front-end, com foco em frameworks de JavaScript. Além disso, tenho a intenção de expandir minha expertise para o back-end, estudando linguagens como Python e C#.`;
